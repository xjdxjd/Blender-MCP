...
gantt
    ...
    section 阶段一：基础架构
    项目初始化与研究           :a1, 2026-05-26, 1d
    目录结构与环境配置         :a2, after a1, 1d
    MCP 服务框架实现           :a3, after a2, 1d
    Blender 插件基础结构       :a4, after a3, 1d
    通信链路验证               :a5, after a4, 1d
    M1里程碑                   :milestone, after a5, 0d

    section 阶段二：3D 打印建模
    ping                        :b0, after a5, 0.5d
    create_object               :b1, after b0, 1.5d
    transform_object            :b2, after b1, 0.5d
    modify_mesh                 :b3, after b2, 1.5d
    delete_object               :b4, after b3, 0.5d
    import和export_model        :b5, after b4, 1d
    check和repair_model        :b6, after b5, 1.5d
    detect_overhangs            :b7, after b6, 1d
    optimize_orientation        :b8, after b7, 1d
    rotate_and_shrinkage        :b9, after b8, 0.5d
    validate_and_export_slicer  :b10, after b9, 1d
    list_objects和scene_info    :b11, after b10, 0.5d
    单元测试编写                :b12, after b11, 1d
    M2里程碑                    :milestone, after b12, 0d

    section 阶段三：文件管理与状态同步
    save和open_project         :c1, after b12, 1d
    状态管理器完善              :c2, after c1, 1d
    事件通知与性能优化          :c3, after c2, 1d
    集成测试                    :c4, after c3, 1d
    M3里程碑                    :milestone, after c4, 0d

    section 阶段四：材质与渲染
    set_material               :d1, after c4, 1.5d
    render_scene               :d2, after d1, 1.5d
    集成测试                    :d3, after d2, 1d
    M4里程碑                    :milestone, after d3, 0d

    section 阶段五：文档与优化
    文档编写                   :e1, after d3, 1.5d
    代码优化与重构              :e2, after e1, 0.5d
    全面测试与Bug修复           :e3, after e2, 1d
    M5里程碑                    :milestone, after e3, 0d
```
